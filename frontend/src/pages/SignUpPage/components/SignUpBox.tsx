...
const SignUpBox = ({firstName, lastName, setFirstName, setLastName, userName, password, setU, setPw, setSubmitted}: 
    {firstName: string, lastName: string, setFirstName: any, setLastName: any, userName: string, password: string, setU: any, setPw: any, setSubmitted: any}) => {
    const signUpBox = {
        width: 250,
        height: '100%',
                ...
                <div className='flex'>
                    <form onSubmit={handleSignUp} className='flex flex-col'>
                        <div className="mb-2" style={{padding: 2}}>
                            <input className="textBox" type="text" placeholder="Enter First Name: " value={firstName} onChange={e => setFirstName(e.target.value)}/>
                        </div>
                        <div style={{padding: 2}}>
                            <input className="textBox" type="text" placeholder="Enter Last Name: " value={lastName} onChange={e => setLastName(e.target.value)}/>
                        </div>
